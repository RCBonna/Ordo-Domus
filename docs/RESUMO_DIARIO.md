...
- Ajustada novamente a proporcao do `Historico Recente` para `45% / 30% / 15%`; versao de validacao atualizada para `V-20260606-19:28:48`.
...
- Corrigida a issue #34: o contador de quantidade dos cards de Inventario/Consumo em tema escuro deixou de usar cor inline quase preta e passou a usar combinacao dark-aware com alto contraste.
